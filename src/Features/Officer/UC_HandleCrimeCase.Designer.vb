...
Partial Class UC_HandleCrimeCase
    ...
    Private Sub InitializeComponent()
        ...
        Panel2.Name = "Panel2"
        Panel2.Size = New Size(1827, 711)
        Panel2.TabIndex = 1
        ' 
        ' Panel8
        ' 
        Panel8.AutoScroll = True
        Panel8.BackColor = SystemColors.Menu
        Panel8.Controls.Add(Panel6)
        Panel8.Controls.Add(PanelInputBundle)
        Panel8.Controls.Add(Panel3)
        Panel8.Controls.Add(Label7)
        Panel8.Controls.Add(cmbSetTaskStatus)
        Panel8.Controls.Add(btnConfirmStatus)
        Panel8.Dock = DockStyle.Fill
        Panel8.Location = New Point(0, 0)
        Panel8.Margin = New Padding(4)
        Panel8.Name = "Panel8"
        Panel8.Size = New Size(1827, 711)
        Panel8.TabIndex = 3
        ' 
        ' Panel6
        ' 
        ...
        Label10.Font = New Font("Garamond", 11F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label10.ForeColor = Color.Black
        Label10.Location = New Point(22, 23)
        ...
        cmbFilterCrimeCategory.Location = New Point(264, 23)
        ...
        cmbFilterCrimeCategory.TabIndex = 71
        ...
        lblReportedByInspector.Font = New Font("Garamond", 12F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        lblReportedByInspector.ForeColor = Color.Black
        lblReportedByInspector.Location = New Point(235, 236)
        ...
        lblReportedByInspector.TabIndex = 70
        ...
        Label9.Location = New Point(13, 232)
        ...
        dgvCrimeCases.Location = New Point(13, 413)
        dgvCrimeCases.Name = "dgvCrimeCases"
        dgvCrimeCases.RowHeadersWidth = 62
        dgvCrimeCases.Size = New Size(626, 402)
        ...
        Label6.Location = New Point(214, 355)
        ...
        uiii.Location = New Point(416, 12)
        ...
        txtCaseDescription.Font = New Font("Garamond", 18F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        ...
        Label2.Name = "Label2"
        Label2.Size = New Size(547, 61)
        Label2.TabIndex = 23
        Label2.Text = "INVESTIGATION PORTAL"
        ' 
        ' Label7
        ' 
        ...
        ' cmbSetTaskStatus
        ' 
        cmbSetTaskStatus.BackColor = SystemColors.Info
        cmbSetTaskStatus.Font = New Font("Garamond", 15.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        cmbSetTaskStatus.ForeColor = Color.Red
        cmbSetTaskStatus.FormattingEnabled = True
        cmbSetTaskStatus.Items.AddRange(New Object() {"South Patrol Team", "North Patrol Team", "Central Patrol Team", "Ajumako Patrol Team"})
        cmbSetTaskStatus.Location = New Point(1076, 107)
        cmbSetTaskStatus.Margin = New Padding(4, 5, 4, 5)
        cmbSetTaskStatus.Name = "cmbSetTaskStatus"
        cmbSetTaskStatus.Size = New Size(440, 44)
        cmbSetTaskStatus.TabIndex = 29
        cmbSetTaskStatus.Text = "--Select--"
        ' 
        ' btnConfirmStatus
        ' 
        btnConfirmStatus.BackColor = Color.FromArgb(CByte(0), CByte(0), CByte(64))
        btnConfirmStatus.Font = New Font("Segoe UI", 10F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        btnConfirmStatus.ForeColor = Color.White
        btnConfirmStatus.Location = New Point(1096, 180)
        btnConfirmStatus.Margin = New Padding(4, 5, 4, 5)
        btnConfirmStatus.Name = "btnConfirmStatus"
        btnConfirmStatus.Size = New Size(282, 61)
        btnConfirmStatus.TabIndex = 36
        btnConfirmStatus.Text = "Set Task Status"
        btnConfirmStatus.UseVisualStyleBackColor = False
        ' 
        ' btnExport
        ' 
        btnExport.BackColor = Color.FromArgb(CByte(0), CByte(0), CByte(64))
        btnExport.Font = New Font("Segoe UI", 10F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        btnExport.ForeColor = Color.White
        btnExport.Location = New Point(1222, 18)
        btnExport.Margin = New Padding(4, 5, 4, 5)
        btnExport.Name = "btnExport"
        btnExport.Size = New Size(282, 61)
        btnExport.TabIndex = 37
        btnExport.Text = "Set Task Status"
        ...
        Controls.Add(Panel1)
        Name = "UC_HandleCrimeCase"
        Size = New Size(1827, 711)
    ...
    Friend WithEvents cmbSetTaskStatus As ComboBox
    Friend WithEvents btnConfirmStatus As Button
