...
Public Class UC_Statistics
    ...
    Private Sub UC_Statistics_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        trackerToolTip.SetToolTip(cmbFilterStatus, "Filter system-wide cases by their current status.")
        trackerToolTip.SetToolTip(cmbFilterByVictim, "Search system-wide cases by the victim's name.")
        trackerToolTip.SetToolTip(dgvTrackCases, "Displays the master case ledger. Images are dynamically loaded.")
        ...
        DataGridViewHelper.AdjustDataGridViewRowHeight(dgvTrackCases, 80)

        ' 3. Load Dropdowns & Calculate System-Wide Stats
        LoadDropdowns()
        CalculateStatistics()
    ...
    Private Sub LoadDropdowns()
        ...
        ' Load ALL distinct victims across the entire system for the Admin
        Dim victimQuery As String = "SELECT DISTINCT victim_name FROM cases ORDER BY victim_name ASC"
    ...
    ' =================================================================
    ' SYSTEM-WIDE STATISTICS ENGINE
    ' =================================================================
    Private Sub CalculateStatistics()
        ' Calculates total cases system-wide and cases marked as COMPLETED
        Dim query As String = "
            SELECT 
    ...
    ' =================================================================
    ' MASTER GRID LOADING (SYSTEM-WIDE)
    ' =================================================================
            ...
            Using conn As MySqlConnection = Database.CreateOpenConnection()
                Using cmd As New MySqlCommand(query, conn)
                    ...
                    If dt.Rows.Count > 0 Then
                        ...
                        dgvTrackCases.Columns.Insert(2, imgCol)
    ...
    Private Sub GenerateAndOpenHtmlReport(reader As MySqlDataReader)
        ...
        Dim printFilePath As String = Path.Combine(Path.GetTempPath(), $"AdminReport_{caseNo}.html")
        ...
        html.AppendLine($"<div>Official Case Report (Administrative Copy)</div>")
        html.AppendLine("</div>")
