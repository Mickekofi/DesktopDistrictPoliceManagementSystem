...
Partial Class InspectorDashboard
    ...
    Private Sub InitializeComponent()
        ...
        FlowLayoutPanelBackground.Size = New Size(1623, 682)
        ...
        PanelWithNavButtons.Controls.Add(btnFileCase)
        ...
        ' btnFileCase
        ' 
        btnFileCase.BackColor = Color.FromArgb(CByte(0), CByte(0), CByte(64))
        btnFileCase.FlatAppearance.BorderSize = 0
        btnFileCase.Font = New Font("Arial Rounded MT Bold", 12F, FontStyle.Bold)
        btnFileCase.ForeColor = Color.Transparent
        btnFileCase.Location = New Point(1167, 19)
        btnFileCase.Margin = New Padding(4, 5, 4, 5)
        btnFileCase.Name = "btnFileCase"
        btnFileCase.Size = New Size(342, 60)
        btnFileCase.TabIndex = 21
        btnFileCase.Text = "File a Case"
        btnFileCase.UseVisualStyleBackColor = False
        ' 
        ' lblFullName
        ' 
        ...
        lblFullName.Location = New Point(157, 48)
        lblFullName.Margin = New Padding(4, 0, 4, 0)
        lblFullName.Name = "lblFullName"
        lblFullName.Size = New Size(127, 31)
        lblFullName.TabIndex = 19
        lblFullName.Text = "Inspector"
        ...
        ClientSize = New Size(1623, 682)
        Controls.Add(Panel1)
        Name = "InspectorDashboard"
        Text = "InspectorDashboard"
    ...
    Friend WithEvents btnFileCase As Button
